<?php
/**
 * @package RRAlvesTerminal
 * @version 0.1.1
 * @deprecated 0.0.9
 */
/*
Plugin Name: RRAlves Terminal
Plugin URI: https://rralves.dev.br/projetos/
Description: RRAlvesTerminal generates a terminal emulation around your text to give it the appearance of an iOS or Linux terminal. Create a terminal with <code>[terminal][/terminal]</code>.
...
class Terminal
{
   ...
   /**
    ...
    {
        wp_register_style('terminal', plugins_url('style/terminal.css', __FILE__));
        // wp_register_style('terminal', plugins_url('rralves-terminal/style/terminal.css'));
